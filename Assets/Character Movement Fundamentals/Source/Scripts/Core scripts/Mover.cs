...
namespace CMF {
    ...
    public class Mover : MonoBehaviour {
        //Collider variables;
        [Header("Mover Options :")] [Range(0f, 1f)] [SerializeField] float stepHeightRatio = 0.25f;
        [Header("Collider Options :")] [SerializeField] float colliderHeight = 2f;
        ...
        //Sensor variables;
        [Header("Sensor Options :")] [SerializeField] public Sensor.CastType sensorType = Sensor.CastType.Raycast;
        private float sensorRadiusModifier = 0.8f;
        private int currentLayer;
        [SerializeField] bool isInDebugMode = false;
        [Header("Sensor Array Options :")] [SerializeField] [Range(1, 5)] int sensorArrayRows = 1;
